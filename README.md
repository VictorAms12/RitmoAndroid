...
![Version](https://img.shields.io/badge/versão-3.4.3-8B95FF)
...
> Versão atual: **3.4.3 — Android + Windows**
...
```text
Ritmo-v3.4.3-Windows
└── Ritmo-v3.4.3-Windows.zip
```
...
Na versão 3.4.3, os dados do Ritmo são armazenados localmente no dispositivo.
...
A versão 3.4.3 possui builds automatizados e validados para **Android** e **Windows** através do GitHub Actions.
